...
def upgrade():
    ...
    op.create_table('organization_name_catalog',
    ...
    sa.UniqueConstraint('name', 'organization_id', name='_organization_name_catalog_name_organization_uc')
    )
    op.create_index('organization_name_catalog_name_idx', 'organization_name_catalog', ['name'], unique=False)
